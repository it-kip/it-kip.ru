...
$opts = array(
	'root'            => $_SERVER['DOCUMENT_ROOT']."/public/uploads/",  //    '../../files',                       // path to root directory
	'URL'             => '/public/uploads/',                            //'http://saturn-r.local/public/uploads',        //    'http://localhost/git/elfinder/files/', // root directory URL
	...
	'uploadAllow'  => array('image', 'pdf'),        // mimetypes which allowed to upload
	'uploadDeny'   => array('js', 'php', 'exe'),    // mimetypes which not allowed to upload
	//'uploadOrder'  => 'allow',                    // order to proccess uploadAllow and uploadAllow options (deny,allow)
