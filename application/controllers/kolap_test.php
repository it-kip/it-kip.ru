...
class kolap_test extends CI_Controller{
    ...
    function index(){
        $this->content = $this->load->view('test/vw_operation_cube', null, true);
    }
    ...
    function select_cube(){
        ...
        $this->content = $this->load->view('test/vw_selcube', $data, true);
    }
    
    function cube_slices(){
        $this->load->view('test/vw_cube_slices', $this->model_kolap->cube_slices($this->input->post("name")));
    }
